...
| 模块名 | 介绍 | 起作用的应用 | 备注 |
| --- | ---| --- | ---|
| [MDWechat][MDWechat] | 微信美化模块 | 微信 | **开源** |
| [微信学英语][微信学英语] | 微信和QQ自动翻译模块 | 微信/QQ |  |
| [畅玩微信][畅玩微信] |  |  |  |
| [微X模块][微X模块] | | | |
| [微信增强插件][微信增强插件] | | | |
|[微信斗图神器][微信斗图神器]| | | |
...
| 模块名 | 介绍 | 起作用的应用 | 备注 |
| --- | ---| --- | ---|
|[QQ净化][QQ净化]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[ColorQQ][ColorQQ]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[QX模块][QX模块]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[QQ斗图神器][QQ斗图神器]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[QQHelper][QQHelper]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[Q++模块][Q++模块]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[baseapk+wifi模块][baseapk+wifi模块]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[QQ红包][QQ红包]|模块介绍 | 作用的应用 | 开源/付费/等 |

### 网易云音乐相关的模块

| 模块名 | 介绍 | 起作用的应用 | 备注 |
| --- | ---| --- | ---|
|[音量放大器][音量放大器]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[云村清洁工][云村清洁工]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[网易云音乐模块][网易云音乐模块]|模块介绍 | 作用的应用 | 开源/付费/等 |

### 抖音相关的模块

| 模块名 | 介绍 | 起作用的应用 | 备注 |
| --- | ---| --- | ---|
|[抖音插件][抖音插件]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[抖音助手™][抖音助手]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[3000模组][3000模组]|模块介绍 | 作用的应用 | 开源/付费/等 |

## 钉钉相关

| 模块名 | 介绍 | 起作用的应用 | 备注 |
| --- | ---| --- | ---|
|[钉钉助手][钉钉助手]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[锤锤][锤锤]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[钉钉打卡™][钉钉打卡]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[钉钉红包][钉钉红包]|模块介绍 | 作用的应用 | 开源/付费/等 |

### 系统相关的模块

| 模块名 | 介绍 | 起作用的应用 | 备注 |
| --- | ---| --- | ---|
|[核心破解™][核心破解]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[边缘手势™][边缘手势]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[绿色守护™][绿色守护]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[吃米™][吃米]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[验证码提取器™][验证码提取器]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[Scene™][Scene]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[MusciNotification™][MusciNotification]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[Sleep™][Sleep]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[无障碍Daemon™][无障碍Daemon]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[PerAppHacking™][PerAppHacking]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[移除截屏延迟™][移除截屏延迟]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[重力工具箱 Android P专用™][重力工具箱P]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[MIUIAODNotification™][MIUIAODNotification]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[一加熄屏增强™][一加熄屏增强]|模块介绍 | 作用的应用 | 开源/付费/等 |

### 虚拟定位

| 模块名 | 介绍 | 起作用的应用 | 备注 |
| --- | ---| --- | ---|
|[模拟位置™][模拟位置]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[Cataclysm™][Cataclysm]|模块介绍 | 作用的应用 | 开源/付费/等 |

### 设备伪装

| 模块名 | 介绍 | 起作用的应用 | 备注 |
| --- | ---| --- | ---|
|[应用变量][应用变量]™|模块介绍 | 作用的应用 | 开源/付费/等 |

### 去广告

| 模块名 | 介绍 | 起作用的应用 | 备注 |
| --- | ---| --- | ---|
|[大圣净化][大圣净化]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[AD快消][AD快消]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[ByeAD][ByeAD]|模块介绍 | 作用的应用 | 开源/付费/等 |

## 步数修改

| 模块名 | 介绍 | 起作用的应用 | 备注 |
| --- | ---| --- | ---|
|[运动模拟器™][运动模拟器]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[运动修改器][运动修改器]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[运动加速器™][运动加速器]|模块介绍 | 作用的应用 | 开源/付费/等 |

### 其他模块

| 模块名 | 介绍 | 起作用的应用 | 备注 |
| --- | ---| --- | ---|
|[BluedHook][BluedHook]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[指纹支付][指纹支付]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[NoLitter™][NoLitter]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[XInternalSD][XInternalSD]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[AllTrans][AllTrans]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[AppTranslator][AppTranslator]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[去你大爷的内置浏览器][去你大爷的内置浏览器]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[App Locale 2][App Locale 2]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[Google App 助手™][Google App 助手]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[Gboard™][Gboard]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[对话框取消][对话框取消]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[Wifi模拟器][Wifi模拟器]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[连接服务修改器][连接服务修改器]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[假装分享][假装分享]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[上帝模式][上帝模式]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[文本自定义][文本自定义]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[XPrivacyLua][XPrivacyLua]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[SnapFreedom][SnapFreedom]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[XInsta][XInsta]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[CoolApkEx][CoolApkEx]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[允许截图™][允许截图]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[阻止更新][阻止更新]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[JustTrustMe][JustTrustMe]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[应用宝Hook][应用宝Hook]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[LuckyHooker][LuckyHooker]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[Maxlock][Maxlock]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[淘饭饭][淘饭饭]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[AIDEHelper][AIDEHelper]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[培训机构识别 VirtualXposed][培训机构识别 VirtualXposed]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[Grindr][Grindr]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[Glitchify][Glitchify]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[YouTube AdAway][YouTube AdAway]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[全部成为F][全部成为F]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[youtubebackgroundplayback][youtubebackgroundplayback]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[颜咚][颜咚]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[哔哩布丁™][哔哩布丁]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[LocationReportEnabler™][LocationReportEnabler]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[谁动了我的剪切板™][谁动了我的剪切板]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[酷狗音乐][酷狗音乐]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[ChromePie][ChromePie]|模块介绍 | 作用的应用 | 开源/付费/等 |
|[反射大师][反射大师]|模块介绍 | 作用的应用 | 开源/付费/等 |
