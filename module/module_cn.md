...
| 模块名 | 版本| 简介| 起待定 |
| --- | ---| --- | ---| 
| [MDWechat][MDWechat] | 3.4.0 |微信美化模块 | 微信 |
| [微信学英语][微信学英语] | 1.7.9 | 微信和QQ自动翻译模块 | 微信/QQ |  
| [微X模块][微X模块] |2.0| 微信功能拓展模块 | 微信: 主要功能 其它应用：隐藏微X |
| [畅玩微信][畅玩微信] | 1.8.8.9|微信功能拓展模块 | 微信 | 
| [微信增强插件][微信增强插件] | 1.9.1|微信功能拓展模块 | 微信 | 
|[微信斗图神器][微信斗图神器]|7.0.3| 微信表情功能增强| 微信 | 
|[微信群消息助手][微信群消息助手]|1.4.4| 微信群消息功能增强| 微信 |
|[微信分组模块][微信分组模块]| 7.0.3|微信消息分组| 微信| 
|[微群发助手][微群发助手]|7.0.3| 微信消息群发增强| 微信 | 
|[微信QQ防止撤回][微信QQ防止撤回]|1.0| 微信QQ消息防撤回| 微信/QQ| 
|[微信红包][微信红包]|1.4.2| 微信抢红包| 微信 | 
|[V++模块][V++模块]|1.0.6| 微信机器人 | 微信 | 
|[微信助手][微信助手]|1.1.3| 微信功能增强| 微信 | 
|[微信密友][微信密友]|1.1.3| 微信联系人隐藏| 微信 | 

### QQ相关的模块

| 模块名 | 版本| 简介 | 起待定 | 
| --- | ---| --- | ---| 
|[QQ净化][QQ净化]| 3.5.0|隐藏QQ相关界面 | QQ | 
|[ColorQQ][ColorQQ]| 1.3.0| QQ美化模块 | QQ |
|[QX模块][QX模块]|1.2.1| QQ功能增强 | QQ: 主要功能 其它：隐藏QX |
|[QQ斗图神器][QQ斗图神器]| 2.0 | QQ表情功能增强 | QQ | 
|[QQHelper][QQHelper]|1.3.1| QQ功能增强 | QQ | 
|[Q++模块][Q++模块]|1.3.1| QQ红包/群管| QQ |
|[baseapk+wifi模块][baseapk+wifi模块]|1.0.3| QQ 文件上传辅助| QQ| 
|[QQRepeater][QQRepeater]|1.1.2| QQ复读机模块 | QQ | 
|[QQNotified][QQNotified]|0.1.2| QQ僵尸粉清理 | QQ | 

### 网易云音乐相关的模块

| 模块名 | 版本| 简介 | 起待定 | 
| --- | ---| --- | ---| 
|[音量放大器][音量放大器]|0.0.31| 音量放大器 | 网易云音乐 |
|[云村清洁工][云村清洁工]|2.7.0| 网易云界面清理 | 网易云音乐 | 
|[网易云音乐模块][网易云音乐模块]|2.8.2| 网易云增强模块 | 网易云音乐 |

### 抖音相关的模块

| 模块名 | 版本| 简介 | 起待定 | 
| --- | ---| --- | ---|
|[抖音助手™][抖音助手]| 5.0| 抖音功能增强 | 抖音 | 
|[3000模组][3000模组]|6.0|抖音功能增强 | 抖音|

## 钉钉相关

| 模块名 |版本| 介绍 | 起待定 | 
| --- | ---| --- | ---|
|[钉钉助手][钉钉助手]| 1.1.1|钉钉打卡 | 钉钉 | 
|[锤锤][锤锤]|0.1|模块介绍 | 钉钉打卡 | 钉钉|
|[钉钉红包][钉钉红包]|1.3.6| 抢红包 | 钉钉 |

### 去广告

| 模块名 |版本| 介绍 | 起待定 | 
| --- | ---| --- | ---|
|[大圣净化][大圣净化]| 1.8.4|各种姿势去广告 | **所有应用** | 
|[AD快消][AD快消]| 1.4.5|启动去启动页广告 | **所有应用** | 
|[ByeAD][ByeAD]|1.2| 去除网易类客户端广告 | 网易类应用 |
|[悟空加速][悟空加速]|1.8.4| 去除网易类客户端广告 | **所有应用** |
|[上帝模式][上帝模式]|2.7.7| 去除任何界面元素 | **所有应用** |

### 系统相关的模块

| 模块名 |版本| 介绍 | 起待定 | 
| --- | ---| --- | ---|
|[核心破解™][核心破解]|1.2.0|降级安装/不同签名安装 | 系统服务 | 
|[边缘手势™][边缘手势]|5.4.2|系统手势功能增强 | 系统服务/系统界面 | 
|[绿色守护™][绿色守护]|4.6.3| 后台进程管控| 系统服务/系统设置 | 
|[吃米™][吃米]|2.4.17| MIUI系统功能增强 | 系统服务/系统界面/安全中心/系统桌面 | 
|[验证码提取器™][验证码提取器]|2.0.23| 自动提取短信验证码 | 系统服务/短信服务 | 
|[Scene™][Scene]|2.0| 微工具箱拓展模块| **所有应用** | 
|[MusciNotification™][MusciNotification]|1.0| 给播放器更好的音乐通知| QQ音乐/网易云音乐 |
|[Sleep™][Sleep]|1.0.0| 强制关闭手机睡觉 | **所有应用** | 
|[无障碍Daemon™][无障碍Daemon]|1.0.2| 避免无障碍服务被关闭 | 系统服务/系统设置 | 
|[PerAppHacking™][PerAppHacking]|1.5| 应用联网控制等 | **所有应用** | 
|[移除截屏延迟™][移除截屏延迟]| 2.0| 秒截屏 | 系统界面|
|[重力工具箱 Android P专用™][重力工具箱P]|beta8|综合性系统增强模块 | 系统界面/系统服务 | 
|[MIUIAODNotification™][MIUIAODNotification]|0.1.2|MIUI息屏音乐通知 | 系统界面 |
|[一加熄屏增强™][一加熄屏增强]|2.0.1|一加息屏功能增强 | 系统界面 | 
|[flyme助手™][flyme助手]|3.2.1|魅族系统增强 | 系统界面 | 
|[hookcoloros™][hookcoloros]|1.3| Oppo系统增强 | 系统界面 | 
|[instantunlock2™][instantunlock2]|2.1.0|快速人脸解锁 | 系统界面 | 
|[NekoSms™][NekoSms]|0.17.0|垃圾短信过滤 | 系统界面 | 
|[NoLockhome™][NoLockhome]|2.2.1|解除开启强制的图案解锁 | 系统界面 | 
|[rootcloak™][rootcloak]|2.3.0| 隐藏Root | **所有应用** | 
|[sudohide™][sudohide]|1.2.8| 隐藏Root | **所有应用** | 
|[zuper™][zuper]|1.2| 隐藏Root | **所有应用** | 
|[完美指纹™][完美指纹]|1.0| 开机第一次也适用指纹解锁 | 系统界面 | 
|[微聚™][微聚]|0.3|一加息屏功能增强 | 系统界面 | 
|[我不要小米市场应用™][我不要小米市场应用]|1.1|去除 MIUI的默认应用市场 | 系统界面 | 
|[lin15™][lin15]|2.4| lin15 系统调教模块 | 待定 | 
|[lin16™][lin15]|0.2| lin16 系统调教模块 | 待定 | 
|[myandroidtoolsxposed™][myandroidtoolsxposed]|0.8.8|myandroidtools附加模块 | 待定 | 
|[PerfectColorBar 小米/华为™][PerfectColorBar1]|1.5.2| 系统导航栏美化 | 待定 | 
|[PerfectColorBar 非小米/华为™][PerfectColorBar2]|1.5.3| 系统导航栏美化 | 待定 |
|[Flat Style Bar Indicators™][Flat Style Bar Indicators]|5.4.3|一加息屏功能增强 | 系统界面 | 
|[进程锁™][进程锁]|3.1.2| 防止进程被杀 | 系统服务 | 

### 虚拟定位

| 模块名 |版本| 介绍 | 起待定 | 
| --- | ---| --- | ---|
|[模拟位置™][模拟位置]|1.2.681.1701|虚拟定位 | 需要模拟位置的应用 | 
|[lataclysm™][Cataclysm]|1.35|虚拟定位 | 需要模拟位置的应用 | 

### 设备伪装

| 模块名 |版本| 介绍 | 起待定 | 
| --- | ---| --- | ---|
|[应用变量][应用变量]™|3.3.2| 修改设备信息 | 需要修改的应用|
|[device faker][device faker]™|1.0| 修改设备信息 | 需要修改的应用|
|[device emulator][device emulator]™|3.5.3| 修改设备信息 | 需要修改的应用|
|[AndroidIDChanger][AndroidIDChanger]™|1.2.3| 修改设备信息 | 需要修改的应用|
|[设备ID更改器][设备ID更改器]™|1.5.3| 修改设备信息 | 需要修改的应用|
|[IMEI Masker][IMEI Masker]™|2.0.1| 修改设备信息 | 需要修改的应用|
...
| 模块名 |版本| 介绍 | 起待定 | 
| --- | ---| --- | ---|
|[运动模拟器™][运动模拟器]|2.7.2| 步数修改模拟 | 待定 | 
|[运动修改器][运动修改器]|2.1.4|步数修改模拟 | 待定 | 
|[运动加速器™][运动加速器]|1.6.1|步数修改模拟 | 待定 | 

### 其他模块

| 模块名 |版本| 介绍 | 起待定 | 
| --- | ---| --- | ---|
|知乎助手|1.0.1|知乎去广告模块|知乎|
|[BluedHook][BluedHook]|1.1.3|Blued软件增强模块 | Blued | 
|[指纹支付][指纹支付]|3.9.2| 让带指纹识别的手机支持指纹支付 | 微信/支付宝/QQ | 
|[全部成为F][全部成为F]|59| 让手机的所有文字都显示为F| 待定 | 
|[XInternalSD][XInternalSD]|1.4| 自定义SD卡存储路径 | 待定 | 
|[NoLitter™][NoLitter]|1.3.4 |阻止应用在SD卡乱创建文件| 待定 | 
|[AllTrans][AllTrans]|1.4| 全能翻译模块| 待定 | 
|[AppTranslator][AppTranslator]|1.1.5|应用翻译模块 | 待定 | 
|[去你大爷的内置浏览器][去你大爷的内置浏览器]|3.0|阻止微信/QQ用内置浏览器打开链接 | 待定 | 
|[App Locale 2][App Locale 2]|2.0.7|单独控制APP内部多语言显示 | 待定 | 
|[酷狗音乐][酷狗音乐]||模块介绍 | 待定 | 
|[ChromePie][ChromePie]|0.7.4|给Chrome浏览器添加菜单 | 待定 | 
|[反射大师][反射大师]|1.9.1| 应用界面调试工具| 待定 | 
|[对话框取消][对话框取消]|1.6.9|强制取消显示部分对话框 | 待定 | 
|[Wifi模拟器][Wifi模拟器]|1.0|Wifi信息模拟 | 待定 | 
|[连接服务修改器][连接服务修改器]|1.4|伪装为wifi或者数据流量 | 待定 | 
|[假装分享][假装分享]|1.2.6| 假装分享 | 待定 | 
|[全民K歌辅助][全民K歌辅助]|1.2| 全民K歌功能增强 | 待定 | 
|[文本自定义][文本自定义]|2.3.1|任意文本自动替换 | 待定 | 
|[XPrivacyLua][XPrivacyLua]|1.24.2|隐私保护 | 待定 | 
|[SnapFreedom][SnapFreedom]|2.9|Snapchat功能增强 | 待定 | 
|[XInsta][XInsta]|2.1.0| Instragram 功能增强 | 待定 | 
|[CoolApkEx][CoolApkEx]|1.2|让酷安直接升级太极内应用 | 待定 | 
|[允许截图™][允许截图]|1.2|取消某些界面无法截图的限制 | 待定 | 
|[阻止更新][阻止更新]|1.3| 阻止App自动更新 | 待定 | 
|[JustTrustMe][JustTrustMe]|.2| 去除HTTPS证书验证| 待定 | 
|[应用宝Hook][应用宝Hook]|1.6|应用宝免流 | 待定 | 
|[LuckyHooker][LuckyHooker]|1.1|去除某些视频应用的广告 | 待定 | 
|[Maxlock][Maxlock]|7.0.4| 给APP添加应用锁| 待定 | 
|[淘饭饭][淘饭饭]|1.2.4|淘宝返利模块 | 待定 | 
|[AIDEHelper][AIDEHelper]|1.2|AIDE功能增强 | 待定 | 
|[培训机构识别 VirtualXposed][培训机构识别 VirtualXposed]|1.3|给招聘类应用自动识别培训机构 | 待定 | 
|[Grindr][Grindr]|5.5.1.1|Grindr功能增强 | 待定 | 
|[Glitchify][Glitchify]|3.2.4|Glitchify功能增强 | 待定 | 
|[YouTube AdAway][YouTube AdAway]|4.3.3|Youtube去广告 | 待定 | 
|[youtubebackgroundplayback][youtubebackgroundplayback]|2.0|Enable Youtube background playback | 待定 | 
|[哔哩布丁™][哔哩布丁]|1.5.8|哔哩哔哩功能增强 | 待定 | 
|[LocationReportEnabler™][LocationReportEnabler]|1.4.0|LocationReportEnabler | 待定 | 
|[谁动了我的剪切板™][谁动了我的剪切板]|1.0| 监控哪个应用在使用剪切板| 待定 | 
|[你才长按复制访问™][你才长按复制访问]|0.0.2| 去除微信内置浏览器对链接的拦截| 待定 | 
|[legend模块™][legend模块]|| 某漫画增强模块| 待定 | 
|[AppContext™][AppContext]|0.4.7.2| Tasker App的附加模块| 待定 | 
|[哔哩漫游™][哔哩漫游]|1.07| 哔哩哔哩增强模块| 待定 | 
|[AnInputHook™][AnInputHook]|| 监控App的输入| 待定 | 
|[麻花助手™][麻花助手]|0.7.0_beta  | 麻花影视增强模块 | 待定 |
|[HushSms™][HushSms]|2.7.7| 系统短信增强模块| 待定 |
|[DroidSward™][DroidSward]|1.0.4| App界面调试工具 | 待定 |
|[BlockSecureFlag™][BlockSecureFlag]|1.4| 取消界面无法截图的限制| 待定 |
|[欅坂メッセージ助手™][欅坂メッセージ助手]|3.3|欅坂メッセージ增强模块 | 待定 |
|[禁止调节音量™][禁止调节音量]|666| 禁止非系统应用调节音量| 待定 |
|[ScanLogin™][ScanLogin]|1.3| 自动登录微信/QQ等| 待定 |
|[原生剪切板™][原生剪切板]|4.8.1| 便捷剪切板访问| 待定 |
|[Undo撤销™][Undo撤销]|1.0.4| 给输入框添加撤销功能| 待定 |
